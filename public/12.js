...
var _OperationRequest = __webpack_require__(1001);

var _OperationRequest2 = _interopRequireDefault(_OperationRequest);

var _editProduct = __webpack_require__(878);
...
exports.default = {
    ...
    methods: {
        ...
        onChangeOutQuantity: function onChangeOutQuantity(e, q) {
            var vm = this;
            var current = _.isInteger(e) ? e : 0,
                previos = _.isInteger(q) ? q : 0;
          ...
          _c("div", { staticClass: "card-header" }, [
            _c("div", { staticClass: "row" }, [
              ...
              _c("div", { staticClass: "col" }, [
                ...
                _vm._v(" " + _vm._s(_vm.product.dosage) + "\n                ")
              ])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "row" }, [
              _c("div", { staticClass: "col" }, [
                ...
                _vm._v(
                  " " +
                    _vm._s(
                      _vm.product.category_id ? _vm.product.category.name : ""
                    ) +
                    "\n                "
                )
              ]),
