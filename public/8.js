            ...
            actionCol: {
                ...
                buttons: [{
                    ...
                    handler: function handler(row) {
                        ...
                        } else if (row.type === 'App\\Notifications\\Reorder' && row.data.supply_id && row.data.type) {
                            //type 1 = supply
                            routerId = row.data.supply_id;
                            routerName = 'supplies.check';
                        } else if (row.type === 'App\\Notifications\\ReorderMedicine' && row.data.product_id) {
                            //type = 0 = office type
